...
func GetAdmin() (string, string, error) {
	settings, err := (settingsDAO{}).GetOne(database.Client, &models.Settings{Key: models.SettingsKeyAdminUsername}, &models.Settings{Key: models.SettingsKeyAdminUsername})
	if err != nil {
		return "", "", err
	}
	...
	settings, err = (settingsDAO{}).GetOne(database.Client, &models.Settings{Key: models.SettingsKeyAdminPassword}, &models.Settings{Key: models.SettingsKeyAdminPassword})
	if err != nil {
		return "", "", err
	}
